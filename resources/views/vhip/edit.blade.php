...
{!! Form::open(['url' => route('vhip.update', $vhip)]) !!}
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="date" id="submit_date" name="submit_date" value="{{ $vhip->submit_date }}">
    </div>
    <div class="form-group">
        <label for="expire_date">Expire Date</label>
        <input class="form-control" type="date" id="expire_date" name="expire_date" value="{{ $vhip->expire_date }}">
    </div>
    <div class="form-group">
